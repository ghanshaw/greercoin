            ...
            <div className="about-scroller">
                ...
                <div className="about-content">
                    ...
                    <p>GreerCoin is an ERC20 compliant etherum token created by me. 
                        ...
                        Please be advised that GreerCoin was created soley for demonstration purpsoses and has NO real monetary value.
                    </p>
                    ...
                    <p>You can also add GreerCoin to your MetaMask plugin as a {getLink(links.customToken, "custom token")}.</p>
                    ...
                    <p>I used various frameworks in order to build this project.</p>
                    <p>The contract code was written in Solidity. I developed the frontend using React, {getLink(links.truffle, "Truffle")} and {getLink(links.web3, "web3")}. 
                        ...
                        I used {getLink(links.metamask, "MetaMask")} and {getLink(links.ganache, "Ganache")} throughout the development process. 
                    ...
                    <p>Lastly, the logo is an {getLink(links.insularG, "insular g")}, a variation of the letter G written in Gaelic script.</p>
